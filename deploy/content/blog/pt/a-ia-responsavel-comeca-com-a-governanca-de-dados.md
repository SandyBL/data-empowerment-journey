...
Para a mecânica mais ampla de propriedade e direitos de decisão, veja [Como construir um modelo operacional de governança de dados](/pt/blog/como-criar-um-modelo-operacional-de-governanca-de-dados/), e para a distinção entre as duas disciplinas em que este artigo se apoia, [Governança de dados vs gestão de dados](/pt/blog/governanca-de-dados-vs-gestao-de-dados-diferencas-chave-e-exemplos-reais/).

Há também um módulo de governança de IA no [curso de governança de dados em português](/pt/course/), com a classificação de riscos, o 5W2H aplicado a um caso de uso de IA, dados sintéticos e privacy by design no treinamento, model cards e auditoria algorítmica, e direitos ARCO, explicabilidade e human-in-the-loop. Ele é um adicional pago dentro de um curso que já é pago, o que digo aqui para que ninguém descubra isso no checkout.
