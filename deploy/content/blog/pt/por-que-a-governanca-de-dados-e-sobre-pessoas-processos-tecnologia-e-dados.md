...
Para a mecânica dos cantos de pessoas e processos especificamente, [Como construir um modelo operacional de governança de dados](/pt/blog/como-criar-um-modelo-operacional-de-governanca-de-dados/) cobre como direitos de decisão se tornam rotinas, e [Introdução aos fundamentos de um programa de governança de dados](/pt/blog/introducao-aos-fundamentos-de-um-programa-de-governanca-de-dados/) expõe os fundamentos na ordem em que eu os construiria.
