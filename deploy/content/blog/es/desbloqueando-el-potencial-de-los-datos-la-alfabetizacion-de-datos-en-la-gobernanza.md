...
Para el detalle operativo de construir alfabetización como capacidad y no como evento, [La alfabetización de datos es una capacidad de negocio](/es/blog/data-literacy-is-a-business-capability/) cubre los hábitos y sistemas de apoyo que la hacen cuajar. Si prefieres empezar averiguando qué lado de esta pareja está más débil en tu organización, la [evaluación de madurez](/es/maturity-assessment/) cubre los dos.
