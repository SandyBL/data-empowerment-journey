...
slug: advisory
nav: advisory
title: Asesoría en Gobierno de Datos — Sesiones y Proyectos | Data Governance Journey
heading: Ayuda con el problema de gobierno que tienes delante
deck: Dos formas de entrar: treinta minutos sobre un problema concreto, o un proyecto con inicio, final y algo que se queda contigo cuando acaba. En remoto, alineado con DAMA, en español, inglés o portugués.
description: Asesoría y acompañamiento en gobierno de datos: una sesión de pago de 30 minutos sobre un problema, un diagnóstico de gobierno, el diseño de un modelo operativo, una práctica de catálogo de datos o un bloque mensual de horas junto a quien lleva el gobierno de datos dentro de la organización.
kicker: Asesoría y acompañamiento
schema: service
service_name: Asesoría y Acompañamiento en Gobierno de Datos (alineado con DAMA)
...
- **Hiciste el [diagnóstico de madurez](/es/maturity-assessment/) y no estás de acuerdo con el resultado**, o sí lo estás y no sabes por cuál de las brechas empezar.
- **Te han pedido que justifiques el gobierno de datos ante finanzas.** Trae el resultado de la [calculadora](/es/calculator/) y lo convertimos en un argumento que sobreviva a un director financiero.
...
Son las mismas tres que describe el [marco de la página de inicio](/#framework), y son la razón de que el trabajo de arriba acabe en decisiones y no en documentos.
...
Los diagnósticos y el trabajo de diseño con alcance cerrado se cotizan a tarifa fija contra un alcance escrito, así que no estás comprando una tarifa diaria abierta. La opción mensual es un bloque de horas. Los talleres se cotizan por sesión, y la [página de talleres](/es/workshops/) detalla lo que incluyen, hasta el espacio privado de simuladores con tu marca y el informe del facilitador.
...
**[Solicitar una sesión →](/?offer=advisory-session#contact-form-start)**: el formulario de contacto se abre con la primera línea ya escrita y la solicitud marcada como sesión. Escribe debajo el problema y lo que ya has intentado. Esa segunda parte nos ahorra a los dos los primeros diez minutos.
