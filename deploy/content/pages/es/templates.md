...
slug: templates
nav: templates
title: Plantillas de Gobierno de Datos — Excel y Word, Sin Correo | Data Governance Journey
heading: Biblioteca de plantillas
deck: Los ficheros de trabajo en Excel y Word que uso en proyectos. Descárgalos, renómbralos, ponles tu logo. Sin formulario.
description: Plantillas gratuitas de gobierno de datos en Excel y Word: identificación de puntos de dolor, encuadre 5W2H, etapas de evolución del gobierno, casos de uso de catálogo, principios y políticas, y un scorecard de gobierno.
...
Son ficheros de trabajo, no teatro de entregables. Son las hojas de cálculo y los documentos que abro en un proyecto real cuando un cliente pregunta cómo es el primer artefacto, lo que significa que tienen columnas en blanco sobre las que se espera que discutas y filas que no te van a aplicar.

{{TEMPLATES}}

## Cómo usarlas sin montar un museo

El modo de fallo de las plantillas es completarlas. Un equipo rellena todas las celdas, circula el fichero, no recibe comentarios y lo archiva; y el ejercicio ha producido un documento en lugar de una decisión.

Tres hábitos lo evitan.

**Rellénalas en una sala, no en tu mesa.** Casi todas son andamios de conversación. La hoja de puntos de dolor vale diez veces más rellenada mal por seis personas de cuatro áreas que rellenada perfecta por ti, porque la discusión sobre qué fila va dónde *es* el hallazgo.
...
**Etapas de evolución del gobierno** describe cómo es cada nivel de madurez en términos de comportamiento, que es lo que hace que un resultado del [diagnóstico de madurez](/es/maturity-assessment/) signifique algo para un patrocinador.
