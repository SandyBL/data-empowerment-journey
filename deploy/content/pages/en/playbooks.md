...
slug: playbooks
nav: playbooks
title: Data Governance and AI Governance Playbooks (PDF, Free) | Data Governance Journey
heading: Playbooks
deck: Two PDF playbooks, one on standing up data governance and one on governing AI, plus the maturity assessment framework as a document. Free, no email.
description: Free PDF playbooks on establishing a data governance program and on AI governance, plus the DAMA-based maturity assessment framework. No email required.
...
Both playbooks work as reading for a governance council, and both work better when the reading is followed by an argument. If you want that argument staged rather than hoped for, the [scenario simulators](/en/resources/) put a room inside the trade-offs, and the [workshop format](/en/workshops/) runs them on your own systems with a facilitator report afterward.
