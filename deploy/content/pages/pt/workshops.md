...
slug: workshops
nav: workshops
title: Workshops de Governança de Dados com Simuladores da Sua Marca | Data Governance Journey
heading: Workshops de governança que sua equipe joga, não aguenta
deck: Conduzo seu workshop nos mesmos simuladores de cenários que este site publica — com a sua marca, reescritos com os seus sistemas e as suas áreas, em um ranking privado — e você fica com o relatório de facilitador.
description: Workshops de governança de dados e alfabetização de dados sobre simuladores de cenários privados e com a marca da sua empresa. Perguntas reescritas com os seus sistemas, ranking privado e relatório de facilitador que fica com você.
kicker: Workshops
schema: service
...
Na prática ele faz duas coisas. Diz onde investir o esforço do próximo trimestre e te dá algo para mostrar a um patrocinador: não "a equipe gostou do workshop", mas "estas são as três áreas em que a nossa própria gente não sabia quem decide, ordenadas".
