...
slug: consulting
nav: consulting
title: Consultoria de Governança de Dados — Formatos, Escopo e Preço | Data Governance Journey
heading: Consultoria de governança de dados que produz decisões
deck: Quatro formatos de projeto, cada um com entregável definido e fim definido. Alinhado à DAMA, remoto e em português, inglês ou espanhol.
description: Consultoria de governança de dados alinhada à DAMA: diagnósticos, desenho de modelo operacional, prática de qualidade de dados e assessoria contínua. Escopo e entregáveis definidos, remoto e em três idiomas.
kicker: Consultoria
schema: service
service_name: Consultoria de Governança de Dados (alinhada à DAMA)
...
A maior parte da consultoria de governança falha de um jeito previsível. Produz um documento de framework, um modelo operacional-alvo ambicioso e um roadmap de três anos, tudo correto e do qual ninguém é responsável na segunda-feira. Dezoito meses depois o framework é um arquivo, o roadmap foi superado e a organização conclui que governança de dados não funciona aqui.

Eu vendo o oposto disso. Todos os formatos abaixo têm algo em comum: terminam com pessoas com nome sustentando decisões com nome, escritas, e com as primeiras já tomadas.

## Como eu trabalho

Três pilares atravessam tudo, e são os mesmos três que o [framework da página inicial](/pt/#framework) descreve.

**Fundamentos de governança: a bússola.** Os direitos de decisão, os domínios e seus donos, as políticas curtas o bastante para serem cumpridas e os padrões concretos o bastante para serem verificados. É a parte genuinamente reutilizável do DMBOK e a que mais frequentemente é superproduzida.

**Caso de uso: o motor.** Governança sem consequência de negócio não tem patrocinador e não sobrevive a um ciclo orçamentário. Então cada projeto é ancorado em algo que o negócio já quer: um achado regulatório a fechar, um relatório em que ninguém confia, um lançamento bloqueado por uma dependência de dados, uma iniciativa de IA que não consegue responder com o que foi treinada.

**Gestão da mudança: o coração.** A razão pela qual a maior parte desse trabalho fracassa. O comportamento novo precisa ser mais fácil que o antigo, visivelmente respaldado por alguém sênior e recompensado ao menos uma vez em público. Se isso não estiver desenhado, o resto é documentação.
...
Tudo é entregue remotamente, em português, inglês ou espanhol, e eu trabalho ao lado do responsável interno sempre que existe um.
