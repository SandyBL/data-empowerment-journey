---
term: Data quality
short: The degree to which data is fit for the purpose someone is using it for — which means quality is always relative to a use.
group: quality
also: DQ, fitness for purpose
