...
short: The explicit record of which role decides, which is consulted, and which is merely informed — per decision, not in general.
group: roles
also: RACI for data, accountability matrix
