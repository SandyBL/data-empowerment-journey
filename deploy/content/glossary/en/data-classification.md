...
short: Labelling data by how sensitive it is, so that handling rules can be applied automatically rather than remembered.
group: ai
...
**In practice.** Four levels is the practical maximum. Every level beyond that produces edge-case arguments and inconsistent tagging, and the difference between "confidential" and "highly confidential" is almost never operationalised differently anyway.
