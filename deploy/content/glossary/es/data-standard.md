...
**En la práctica.** Los estándares son el punto donde el gobierno deja de ser abstracto, porque cada uno puede convertirse en una regla de calidad con un umbral y un panel. La secuencia útil es corta: nombra el elemento de datos crítico, escribe su estándar, impleméntalo como regla, reporta la tasa de incumplimiento.
