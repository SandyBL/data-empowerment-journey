...
export const content = {
  en: {
    ...
    removal: "Already published something you want changed or taken down? Write to {email} and it comes off the wall.",
    cancel: "Cancel",
    sending: "Submitting…",
  ...
  es: {
    ...
    removal: "¿Ya publicaste algo que quieres cambiar o retirar? Escribe a {email} y lo quitamos del muro.",
    cancel: "Cancelar",
    sending: "Enviando…",
  ...
  pt: {
    ...
    removal: "Já publicou algo que quer alterar ou remover? Escreva para {email} e retiramos do mural.",
    cancel: "Cancelar",
    sending: "Enviando…",
