...
const content = {
  en: {
    ...
    assessmentLead: "Complete the assessment to identify your current strengths, gaps, and most valuable governance priorities.",
    assessmentButton: "Start the assessment",
  ...
  es: {
    ...
    assessmentLead: "Completa la evaluación para identificar tus fortalezas, brechas y prioridades de gobierno más valiosas.",
    assessmentButton: "Comenzar la evaluación",
  ...
  pt: {
    ...
    assessmentLead: "Conclua a avaliação para identificar seus pontos fortes, lacunas e prioridades de governança mais valiosas.",
    assessmentButton: "Iniciar a avaliação",
