...
- **Foundations and policies — "The Compass."** Governance operating model, roles
  and decision rights, data ownership and stewardship, policy and standards.
- **MVP and tooling — "The Engine."** A first governed domain end to end: data
  quality profiling, a business glossary, metadata, and the minimum tooling that
  makes them stick.
- **Change management and data culture — "The Heart."** Data literacy workshops,
  communication plans, and the executive sponsorship that decides whether any of
  the above survives its first quarter.

## Positions this site argues
...
- Data literacy is a business capability with a measurable owner, not a training
  budget line.
- Responsible AI is downstream of data governance: lineage, quality, and
  ownership are what make a model auditable.
